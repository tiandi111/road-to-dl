...
void bench::CifarResNetInfer() {
    ...
    cf.LoadTest(N);
    // load model
    ifstream in("/Users/tiandi03/road-to-dl/Project636/res_cifar_1605275406.onnx", ios_base::binary);
...
void bench::TorchCifarResNetInfer() {
    ...
    module = torch::jit::load("/Users/tiandi03/road-to-dl/Project636/res_cifar_1605275406.jit");
    module.eval();
    //
